...
const FeedbackComponent = () => {
  return (
    <div className="m-10 border rounded-3xl">
      <div className="m-4">
        <span className="m-3">
        <img src="/images/qoute2.png"/> <p className="leading-8 text-xl "> His insight and expertise have been transformative, offering
          ...
          professional development. "</p><img src="/images/qoute1.png"/>
        </span>
      </div>
      <div className="flex m-4">
        ...
        <div className="text-xl m-2 ">Jack Sebastian</div>
      </div>
    </div>
  );
};
