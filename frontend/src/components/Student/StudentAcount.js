            ...
            <div className="flex">
              ...
              <div>
                ...
                <div className="m-20 mt-10 ml-0   rounded-lg  w-3/4  h-max hover:cursor-pointer  transform hover:scale-95 transition duration-150 ease-in-out  ">
                  ...
                  <p className="p-10">
                    I am a dedicated and motivated college student, set to
                    graduate in May 2025, with a strong passion for academic
                    excellence and personal growth. My academic journey has been
                    marked by a commitment to learning, with a particular focus
                    on developing both technical and soft skills. I thrive in
                    collaborative environments, often taking the lead in team
                    projects and actively participating in extracurricular
                    activities. My adaptability and critical thinking abilities
                    have been honed through diverse coursework and hands-on
                    experiences. I am passionate about leveraging my knowledge
                    to drive meaningful change and make a positive impact in my
                    chosen field. With a keen interest in continuous learning, I
                    am eager to embrace new challenges and opportunities that
                    will further shape my professional and personal development.
                  </p>
                </div>
              </div>
            </div>
